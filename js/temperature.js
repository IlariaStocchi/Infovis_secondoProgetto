...
function temperatureAugust() {
    ...
    d3.csv("data/CSV/08/2020-08-temperature-average.csv",
           function(d){
               return { date : d3.timeParse("%Y-%m-%dT%H:%M:%S.%LZ")(d.created), value : d.value }})
    .then(
...
function temperatureSeptember() {
    ...
    d3.csv("data/CSV/09/2020-09-temperature-average.csv",
           function(d){
               return { date : d3.timeParse("%Y-%m-%dT%H:%M:%S.%LZ")(d.created), value : d.value }})
    .then(
...
function temperatureOctober() {
    ...
    d3.csv("data/CSV/10/2020-10-temperature-average.csv",
           function(d){
               return { date : d3.timeParse("%Y-%m-%dT%H:%M:%S.%LZ")(d.created), value : d.value }})
    .then(
...
function temperatureNovember() {
    ...
    d3.csv("data/CSV/11/2020-11-temperature-average.csv",
           function(d){
               return { date : d3.timeParse("%Y-%m-%dT%H:%M:%S.%LZ")(d.created), value : d.value }})
    .then(
...
function temperatureDecember() {
    ...
    d3.csv("data/CSV/12/2020-12-temperature-average.csv",
           function(d){
               return { date : d3.timeParse("%Y-%m-%dT%H:%M:%S.%LZ")(d.created), value : d.value }})
    .then(
